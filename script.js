...
let v1 = new Vec2(triCenter.x + random(0, triMaxDist), triCenter.y + random(0, triMaxDist));
let v2 = new Vec2(triCenter.x + random(0, triMaxDist), triCenter.y + random(0, triMaxDist));
let v3 = new Vec2(triCenter.x + random(0, triMaxDist), triCenter.y + random(0, triMaxDist));
